...
const useNavigationState = () =>
{
    ...
    const [ activeTab, setActiveTab ] = useState<IPage>(pages[0]);
    ...
    return { fetchPages, pages, activeTab, setActiveTab, activePage, setActivePage, getNavigationTabs, getSubPages,getParentFor, componentsForPageColumn, shouldRedirect, minimal };
}
